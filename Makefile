...
build: ## Builds the Docker images
	...
	"service-package-follower service-notifier service-downloader service-dispatcher plugin-codeql plugin-js-license plugin-js-patching plugin-js-sbom plugin-js-vuln-finder"
